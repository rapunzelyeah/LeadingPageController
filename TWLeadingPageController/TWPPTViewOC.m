...
#import "TWPPTViewOC.h"

static NSString *const kCellId = @"TWPPTViewCell";

@interface TWPPTViewOC () <UICollectionViewDelegate, UICollectionViewDataSource, UIScrollViewDelegate, UICollectionViewDelegateFlowLayout> {
    CGPoint beginOffset;
}
...
- (void)commonInit {
    ...
    _scrollDuration = 3.f;
    _pageControlPosition = TWPPTViewPageControlPositionBottomCenter;
...
- (void)setPageControlPositon:(TWPPTViewPageControlPosition)pageControlPosition {
